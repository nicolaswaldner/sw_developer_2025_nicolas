...
namespace Wifi.PlaylistEditor.BaseTypes.Test
{
    ...
    public class PlaylistTests
    {
        ...
        [Test]
        public void Add() //bei Methoden Tests, Methoden Name als Test Name verwenden
        {
            //arrange
            _fixture = new Playlist("Demo", "DJ Gandalf");
            _mockedItem1 = new Mock<IPlaylistItem>(); //erzeugt Ersatz-Object für Interface IPlaylistItem
            var existingItemCount = _fixture.Items.Count();
        ...
        [Test]
        public void Title_Read() //beim Testen von Properties, Property Name + Read/Write (je nach was es kann)
        {
            //arrange
