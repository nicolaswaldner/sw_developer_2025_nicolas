...
namespace SD.Core.EnumDescriptors
{
      ...
      where T : Enum
    {
        ...
        public string ResourceKey { get; } //Resource Name der bei Übersetzung angegeben wird

        protected EnumDescriptorBase(T @enum, string code, string resourceKey)
        {
            Enum = @enum;
            Code = code; //Code ist die String Repräsentation des Enums, z.B. "10" für Ratings.Bad
